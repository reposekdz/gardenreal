...
// Source: Rwanda Administrative Units (NISR data)

const RWANDA_LOCATIONS = {
  "Umujyi wa Kigali": {
    "Gasabo": ["Bumbogo","Gatsata","Gikomero","Gisozi","Jabana","Jali","Kacyiru","Kimihurura","Kimironko","Kinamba","Kinyinya","Ndera","Nduba","Remera","Rusororo","Rutunga"],
  ...
  "Intara y'Amajyaruguru": {
    ...
    "Gicumbi": ["Bukure","Bwisige","Byumba","Cyumba","Giti","Kaniga","Manyagiro","Miyove","Mukarange","Muko","Mutete","Nyamiyaga","Nyankenke II","Rubaya","Rugalika","Rukomo","Rushaki","Rutare","Ruvune","Rwamiko","Sake","Shangasha"],
  ...
  "Intara y'Amajyepfo": {
    "Gisagara": ["Gikonko","Gishubi","Kansi","Kigembe","Mamba","Muganza","Mugombwa","Mukindo","Musha","Ndora","Nyanza","Save"],
    "Huye": ["Gishamvu","Huye","Karama","Kigoma","Kinazi","Maraba","Mbazi","Mukura","Ngoma","Ruhashya","Rusatira","Rwaniro","Simbi","Tumba"],
    "Kamonyi": ["Gacurabwenge","Kamonyi","Kayenzi","Kayumbu","Mugina","Musambira","Ngamba","Nyamiyaga","Nyarubaka","Rugarika","Rukoma","Runda"],
    "Muhanga": ["Cyeza","Kabacuzi","Kibangu","Kiyumba","Muhanga","Mushishiro","Nyabinazi","Nyamabuye","Nyamiyaga","Rongi","Rugendabari","Shyogwe"],
    ...
    "Nyaruguru": ["Cyahinda","Kibeho","Kivu","Mata","Muganza","Munini","Ngera","Ngoma","Nyabimata","Nyagisozi","Ruheru","Ruramba","Rusenge","Rusenge","Simbi","Uwinkingi"],
    "Ruhango": ["Bweramana","Byimana","Kabagari","Kinazi","Kinihira","Mbuye","Muyira","Ntongwe","Ruhango"]
  },
  "Intara y'Iburasirazuba": {
    ...
    "Gatsibo": ["Gasange","Gatsibo","Gitoki","Kabarore","Kagitumba","Kiramuruzi","Kiziguro","Muhura","Murambi","Ngarama","Nyagihanga","Remera","Rugarama","Rwimbogo"],
    "Kayonza": ["Gahini","Kabare","Kabarondo","Mukarange","Murama","Murundi","Mwiri","Ndego","Nyamirama","Rukara","Ruramira","Rwinkwavu"],
    "Kirehe": ["Gahara","Gatore","Kigarama","Kigina","Kirehe","Mahama","Mpanga","Musaza","Mushikiri","Nasho","Nyamugali","Rwimbogo"],
    "Ngoma": ["Gashanda","Jarama","Karembo","Kazo","Kibungo","Mugesera","Murama","Mutenderi","Remera","Rukira","Rukumberi","Rurenge","Sake","Zaza"],
    "Nyagatare": ["Gatunda","Karama","Karangazi","Katabagemu","Kavirundo","Kibali","Matimba","Mimuli","Mukama","Musheli","Nyagatare","Rwimiyaga","Tabagwe"],
  ...
  "Intara y'Iburengerazuba": {
    ...
    "Rubavu": ["Bugeshi","Busasamana","Cyanzarwe","Giheke","Gisenyi","Kanama","Kanzenze","Mudende","Nyakiliba","Nyamyumba","Nyundo","Rubavu","Rugerero"],
    "Rusizi": ["Bugarama","Bweyeye","Giheke","Gihundwe","Gikundamvura","Gitambi","Kamembe","Muganza","Mururu","Nkungu","Nyakabuye","Nyakarenzo","Nzahaha","Rwimbogo"],
    "Rutsiro": ["Boneza","Gihango","Kigeyo","Kivumu","Manihira","Mukura","Murunda","Musasa","Mushonyi","Mushubati","Nyabirasi","Ruhango","Rusebeya"]
  }
};

module.exports = RWANDA_LOCATIONS;
